export const Moves: {[k: string]: ModdedMoveData} = {
	...
	instruct: {
		...
		onHit(target, source) {
			...
			const noInstruct = [
				'assist', 'beakblast', 'belch', 'bide', 'celebrate', 'copycat', 'focuspunch', 'iceball', 'instruct', 'kingsshield', 'mefirst', 'metronome', 'mimic', 'mirrormove', 'naturepower', 'obstruct', 'outrage', 'petaldance', 'rollout', 'shelltrap', 'sketch', 'sleeptalk', 'struggle', 'thrash', 'transform', 'uproar',
			];
	...
	spite: {
		...
		onHit(target) {
			const lastMove = target.m.lastMoveAbsolute;
			if (!lastMove || lastMove.isZ) return false;
