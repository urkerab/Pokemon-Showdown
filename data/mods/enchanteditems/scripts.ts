export const Scripts: ModdedBattleScriptsData = {
	...
	init() {
		...
		Object.keys(abilityToItem).forEach(ability => {
			...
			this.itemCache.set(itemid as ID, {
	...
	getItem(name) {
		...
		const ability = itemToAbility[this.toID(name)];
		if (ability) return {...this.dex.getAbility(ability), ability: ability, onTakeItem: false};
		return Object.getPrototypeOf(this).getItem.call(this, name);
	},
	pokemon: {
		hasItem(item) {
			if (this.battle.dex.getItem(this.item).ability) return false;
