export const Scripts: ModdedBattleScriptsData = {
	...
	init() {
		...
		this.modData('Learnsets', 'meloetta').learnset.moonblast = ['6L1'];
		this.modData('Learnsets', 'meloetta').learnset.playrough = ['6L1'];
		...
		this.modData('Learnsets', 'reuniclus').learnset.barrage = ['6L1'];
